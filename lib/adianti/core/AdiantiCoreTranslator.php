...
class AdiantiCoreTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['es'][] = 'Registros excluidos';
        ...
        $this->messages['es'][] = 'Use el método ^1';
        $this->messages['es'][] = 'Formulario sin campos';
        ...
        $this->messages['es'][] = 'El campo ^1 contiene un mensaje de correo electrónico no válido';
        $this->messages['es'][] = 'El campo ^1 debe ser numérico';
        $this->messages['es'][] = 'Sin transacciones activas con la base de datos';
        ...
        $this->messages['es'][] = 'Debe ejecutar el constructor de ^1';
        $this->messages['es'][] = 'Debe ejecutar ^1 antes de ^2';
        $this->messages['es'][] = 'Debe pasar el ^1 (^2) como parámetro a ^3';
        $this->messages['es'][] = 'El parámetro (^1) de ^2 es obligatorio';
        $this->messages['es'][] = 'El parámetro (^1) del constructor de ^2 es obligatorio';
        $this->messages['es'][] = 'Has agregado un campo llamado "^1" al formulario';
        $this->messages['es'][] = 'Cerrar la aplicación?';
        $this->messages['es'][] = 'Use addField () o setFields () para definir los campos del formulario';
        $this->messages['es'][] = 'Compruebe si la acción (^1) existe';
        $this->messages['es'][] = 'Información';
        $this->messages['es'][] = 'Error';
        $this->messages['es'][] = 'Excepción';
        $this->messages['es'][] = 'Cuestión';
        $this->messages['es'][] = 'La clase ^1 no se aceptó como argumento. El parámetro debe ser subclase de ^2. ';
        $this->messages['es'][] = 'La clase ^1 no se aceptó como argumento. El parámetro debe implementar ^2. ';
        $this->messages['es'][] = 'La clase ^1 no se ha encontrado. Compruebe el nombre de la clase o del archivo. Ellos deben coincidir ';
        $this->messages['es'][] = 'Nombre de propiedad reservado (^1) en la clase ^2';
        $this->messages['es'][] = 'La acción (^1) debe ser estática para utilizarse en ^2';
        $this->messages['es'][] = 'Intento de acceso a una propiedad no existente (^1)';
        $this->messages['es'][] = 'Formulario no encontrado. Compruebe que ha pasado el campo (^1) a setFields () ';
        $this->messages['es'][] = 'Clase ^1 no encontrada en ^2';
        $this->messages['es'][] = 'Debe ejecutar ^1 antes de agregar el componente';
        ...
        $this->messages['es'][] = 'Clase ^1 no encontrada';
        $this->messages['es'][] = 'Método ^1 no encontrado';
        $this->messages['es'][] = 'Compruebe el nombre de la clase o del archivo';
        $this->messages['es'][] = 'Borrar';
        $this->messages['es'][] = 'Seleccionar';
        $this->messages['es'][] = 'Debe definir el campo para la acción (^1)';
        $this->messages['es'][] = 'La sección (^1) no se cerró correctamente';
        $this->messages['es'][] = 'El método ^1 sólo acepta valores del tipo ^2 entre ^3 y ^4';
        $this->messages['es'][] = 'La clase interna ^1 no se puede ejecutar';
        $this->messages['es'][] = 'La versión mínima requerida para PHP es ^1';
        $this->messages['es'][] = '^1 no definido. Debe ejecutar ^2 en ^3 ';
        $this->messages['es'][] = 'Database';
        $this->messages['es'][] = 'Generador';
        $this->messages['es'][] = 'Registros';
        $this->messages['es'][] = 'Descripción';
        $this->messages['es'][] = 'Error al copiar archivo a ^1';
        $this->messages['es'][] = 'Permiso denegado';
        $this->messages['es'][] = 'Extensión no permitida';
        $this->messages['es'][] = 'Error hash';
        $this->messages['es'][] = 'Parámetro (^1) no válido en ^2';
        $this->messages['es'][] = 'Atención';
        $this->messages['es'][] = 'Ningún registro encontrado';
